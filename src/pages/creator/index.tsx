...
import { Row, Col, Form, Button, Spinner, Container, Tabs, Tab } from "react-bootstrap";
...
export default function Creator() {
    ...
    return (
        <Container className='mh-100vh mb-5'>
                ...
                !id ?
                    <>
                        ...
                        <Tabs
                            ...
                            className="mb-3"
                        >
                            <Tab eventKey="trail" title="Nova Trilha">
                                <Container className='selectDiv'>
                            ...
                            <Tab eventKey="content" title="Novo Conteúdo">
                                <Container className='selectDiv'>
            ...
            <div className="mt-4"><Title title={!id ? 'Novo Artigo' : 'Editar Artigo'} /></div>
            ...
            <form onSubmit={sendArticle}>
                ...
                <div className='textCreateDiv'>
                    ...
                    <Button type='submit' disabled={!user?.active} className="w-100 my-4 buttonDefault">
                        {!loading ?
                            'Salvar' :
                            <Spinner
                                as="span"
